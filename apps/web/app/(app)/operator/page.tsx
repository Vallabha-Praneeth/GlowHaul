    ...
    <div className="stack">
      ...
      <div className="card-grid">
        ...
        <section className="card" data-testid="operator-incoming-offers">
          ...
          <div className="stack" data-testid="operator-incoming-offers-list" style={{ marginTop: 18 }}>
      ...
      <section className="card" data-testid="operator-recent-history">
        <div className="section-header">
          <div>
            <h2 style={{ margin: 0 }}>Recent history</h2>
            <div className="fine" style={{ marginTop: 6 }}>
              Closed, cancelled, and client-ready campaigns for fast recap and follow-up.
            </div>
          </div>
